...
\node[pipebox, below=0.65cm of L4] (L5) {%
    ...
    EOS terminal state; sequence closes when selected
};
...
\node[refute, right=0.6cm of L5.east] {%
    EOS reachable through model's own selection.\\
...
\node[below=0.7cm of output, font=\scriptsize, text=refutegray, text width=13cm, align=center] {%
    ...
    No stage introduces indeterminacy, defers determination, or fails to complete.
};
